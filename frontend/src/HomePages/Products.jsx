...
const products = [
  { img: '/images/30.webp', name: 'Lan Mountain Chair',         desc: 'A striking dining collection with warm oak surfaces and sculpted bench seating.',                                          category: 'Dining' },
  { img: '/images/31.webp', name: 'Hammered Accent Side Table', desc: 'Sculptural side table featuring a hand-textured metallic base and smooth wooden top for a refined modern look.',          category: 'Lounges' },
  { img: '/images/32.webp', name: 'Horizon Luxe Bed',           desc: 'Designed to bring premium comfort and elegant luxury to refined bedroom interiors.',                                       category: 'Bedroom' },
  { img: '/images/33.webp', name: 'Aura Bedside Cabinet',       desc: 'Crafted to enhance contemporary bedrooms with elegant storage and refined functionality.',                                 category: 'Storage' },
  { img: '/images/35.webp', name: 'Bespoke Bed Frame',          desc: 'Designed for restful bedrooms, with clean lines and durable construction.',                                                category: 'Bedroom' },
  { img: '/images/34.webp', name: 'Heritage Writing Desk',      desc: 'Perfect for modern workspaces and reading corners that blend comfort with sophisticated style.',                           category: 'Study' },
  { img: '/images/36.webp', name: 'Luna Coffee Table',          desc: 'Modern coffee table crafted with a sleek glass top, soft curves, and functional open storage.',                           category: 'Living spaces' },
  { img: '/images/37.webp', name: 'Prestige Display Cabinet',   desc: 'Luxury storage cabinet featuring a transparent top display and spacious compartmentalized drawers.',                      category: 'Living spaces' },
  { img: '/images/38.webp', name: 'Haven Lounge Chair',         desc: 'Stylish lounge chair designed with plush upholstery, rounded forms, and premium comfort seating.',                        category: 'Accents' },
  { img: '/images/39.webp', name: 'Nova Storage Cabinet',       desc: 'Contemporary storage cabinet designed with clean lines, spacious drawers, and a sleek matte finish.',                     category: 'Storage' },
  { img: '/images/40.webp', name: 'Eclipse Dining Table',       desc: 'Luxury dining table featuring a sculptural metallic base and sophisticated marble-inspired tabletop.',                    category: 'Dining' },
  { img: '/images/41.webp', name: 'Verona Lounge Sofa',         desc: 'Elegant lounge sofa offering plush cushioning, curved armrests, and exceptional everyday comfort.',                       category: 'Living spaces' },
];
